...
RowLayout
{
    ...
    FooterButtonSubstrate
    {
        ...
        IconedButton
        {
            ...
            height: parent.width*0.7
            anchors.centerIn: parent
            // dont ask me why i have this issue with iPhone X and XS
            buttonIconAlias.anchors.horizontalCenterOffset: Vars.isXorXS ? -0.5 : 0
            buttonIconAlias.anchors.verticalCenterOffset:   Vars.isXorXS ? -0.5 : 0
